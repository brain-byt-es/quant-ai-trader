...
from database.models import HedgeFundFlowRun
from models.schemas import FlowRunStatus
...
class FlowRunRepository:
    ...
    def create_flow_run(self, flow_id: int, request_data: Optional[Dict[str, Any]] = None) -> HedgeFundFlowRun:
        ...
        flow_run = HedgeFundFlowRun(flow_id=flow_id, request_data=request_data, run_number=run_number, status=FlowRunStatus.IDLE.value)
