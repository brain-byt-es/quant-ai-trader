...
from models.events import CompleteEvent, ErrorEvent, ProgressUpdateEvent, StartEvent
...
from services.graph import create_graph, parse_hedge_fund_response, run_graph_async
    ...
    try:
        ...
        async def event_generator():
            ...
            try:
                ...
                # Stream progress updates until run_task completes AND queue is empty
                ...
                while not run_task.done() or not progress_queue.empty():
                    ...
                    try:
                        # Use a shorter timeout to stay responsive
    ...
    try:
        ...
        async def event_generator():
            ...
            try:
                ...
                # Stream progress updates until backtest_task completes AND queue is empty
                # or client disconnects
                while not backtest_task.done() or not progress_queue.empty():
                    # Check if client disconnected
                    if disconnect_task.done():
